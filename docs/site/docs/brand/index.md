...
**[View the Brand Kit](brand-kit.html)**{ .md-button .md-button--primary }

## Assets

SVG logo and favicon files are available in the repository:

- [`docs/site/docs/assets/logo.svg`](https://github.com/platzhersh/open-cis/blob/main/docs/site/docs/assets/logo.svg) -- Logo mark (white top brick for dark backgrounds)
- [`docs/site/docs/assets/favicon.svg`](https://github.com/platzhersh/open-cis/blob/main/docs/site/docs/assets/favicon.svg) -- Favicon (simplified, no studs)
- [`docs/brand/brand-kit.html`](https://github.com/platzhersh/open-cis/blob/main/docs/brand/brand-kit.html) -- Full interactive brand kit
