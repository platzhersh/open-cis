...
- Add OIDC server-to-server URL overrides and improve auth logging (#103) ([#103](https://github.com/platzhersh/open-cis/pull/103)) by @platzhersh
## [0.7.3] - 2026-04-17

### Bug Fixes

- Replace Dex's DEX_EXPAND_ENV with custom entrypoint for Railway (#102) ([#102](https://github.com/platzhersh/open-cis/pull/102)) by @platzhersh
## [0.7.2] - 2026-04-17
...
- Configure Vite build-time environment variables in Docker (#100) ([#100](https://github.com/platzhersh/open-cis/pull/100)) by @platzhersh
## [0.7.0] - 2026-04-17

### Features

- Add OIDC authentication with Dex and role-based access control (#84) ([#84](https://github.com/platzhersh/open-cis/pull/84)) by @platzhersh
## [0.6.1] - 2026-04-17

### Bug Fixes

- Downgrade Tailwind CSS from v4 to v3 (#99) ([#99](https://github.com/platzhersh/open-cis/pull/99)) by @platzhersh

### Miscellaneous

- Add oehrpy SDK version to system info (#90) ([#90](https://github.com/platzhersh/open-cis/pull/90)) by @platzhersh

### Build

- **deps-dev**: Bump tailwindcss from 3.4.19 to 4.2.2 in /web (#98) ([#98](https://github.com/platzhersh/open-cis/pull/98)) by @dependabot[bot]
## [0.6.0] - 2026-04-10
...
- Add ADR-0009 oehrpy Web Template integration for FLAT path sourcing (#82) ([#82](https://github.com/platzhersh/open-cis/pull/82)) by @platzhersh

### Miscellaneous

- **api**: Add ability to remove "No Known Allergies" declarations (#81) ([#81](https://github.com/platzhersh/open-cis/pull/81)) by @platzhersh
## [0.3.4] - 2026-03-29
